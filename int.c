...
static SpkMethodTmpl methods[] = {
    ...
    { "__add__",    SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_add    },
    { "__sub__",    SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_sub    },
    { "__lshift__", SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_lshift },
    { "__rshift__", SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_rshift },
    { "__lt__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_lt     },
    { "__gt__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_gt     },
    { "__le__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_le     },
    { "__ge__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_ge     },
    { "__eq__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_eq     },
    { "__ne__",     SpkNativeCode_ARGS_1 | SpkNativeCode_LEAF, &Integer_ne     },
